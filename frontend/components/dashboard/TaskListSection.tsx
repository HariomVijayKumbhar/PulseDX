      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center justify-between w-full md:w-auto gap-3">
          ...
          {onNewTaskClick && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold bg-indigo-600 hover:bg-indigo-500 text-white shadow-md shadow-indigo-500/20 active:scale-95 transition-all md:hidden shrink-0"
            >
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3 w-full md:w-auto">
          {onNewTaskClick && (
            <button
              onClick={onNewTaskClick}
              className="hidden md:inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold bg-indigo-600 hover:bg-indigo-500 text-white shadow-md shadow-indigo-500/20 active:scale-95 transition-all shrink-0"
            >
              <Plus className="w-3.5 h-3.5" />
              <span>New Task</span>
            </button>
          ...
          <div className="relative">
            <select
              ...
              className="w-full sm:w-auto px-3 py-2 rounded-xl text-xs bg-slate-100/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 cursor-pointer transition-all"
            >
